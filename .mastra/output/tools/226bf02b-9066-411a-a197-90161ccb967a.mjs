...
const siteAuditTool = createTool({
  id: "site-audit",
  ...
  execute: async ({ context }) => {
    const auditResults = await performSiteAudit();
    return auditResults;
  }
});
async function performSiteAudit(url, options) {
...
export { siteAuditTool };
//# sourceMappingURL=226bf02b-9066-411a-a197-90161ccb967a.mjs.map
